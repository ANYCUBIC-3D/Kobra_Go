  ...
  void MarlinUI::status_screen() {
    ...
    const bool busy = printingIsActive();
     ...
     TERN_(HAS_LCD_MENU, ENCODER_RATE_MULTIPLY(false));
      ...
      if (use_click()) {
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR_F("seclect",seclect);
#endif
       switch(seclect){
//       case 0:             //去主界面
//            #if BOTH(FILAMENT_LCD_DISPLAY, SDSUPPORT)
...
//        break;
        case 1:       
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR("lcd_setTargetHotend");
#endif	   	
        ...
        case 2:
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR("lcd_setTargetBED");
#endif				         
        ...
        case 3:
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR("Lcd_set_Fan0");
#endif	  
         ...
         case 4:
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR("lcd_babystep_zoffset");
#endif		 		 
        ...
        case 5:
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR("Lcd_set_feedrate");;
#endif		
...
//              }
        ...
        case 8:               //中止打印
#ifdef SD_LOG	  	
		SERIAL_ECHOLNPAIR("LCD_abort_pring");
#endif    
		  if(TERN0(SDSUPPORT, IS_SD_PRINTING() || IS_SD_PAUSED()))
		  {
...
void check_endstops()
{
	...
	bool probe_state = READ(AUTO_LEVEL_RX_PIN)!= Z_MIN_PROBE_ENDSTOP_INVERTING;
	static uint8_t cur_endstops_state = x_state<<2 | y_state<<1 | z_state;
	static uint8_t prv_endstops_state = cur_endstops_state;
	
	cur_endstops_state = probe_state<<3 | x_state<<2 | y_state<<1 | z_state;
	...
	if(!endstops.enabled){
		...
		if(!endstops.endstop_state && cur_endstops_state){
				sprintf_P(cmd, PSTR("endstop_state: x%d  y%d z%d p%d"), x_state,y_state,z_state,probe_state);
...
//                  if (encoderStepRate >= ENCODER_1000X_STEPS_PER_SEC)     encoderMultiplier = 1000;
                  ...
                  #define ENCODER_RATE_MULTIPLIER_DEBUG
                    ...
                    SERIAL_ECHO_START();
                    SERIAL_ECHOLNPAIR("Enc Step Rate: ", encoderStepRate);
                    SERIAL_ECHOLNPAIR("  Multiplier: ", encoderMultiplier);
